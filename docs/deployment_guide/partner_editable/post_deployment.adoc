...
//TODO Troy, This link opens a page in Korean, and it doesn't appear to be an installation guide. What URL should we point to instead? - Fixed for English

//TODO Troy, What other Tibero resources are available to support people after they've deployed this Quick Start? none