...
#aws s3 cp s3://$S3_BUCKET_NAME/scripts/tbdsn.template $TB_HOME/config/tbdsn.template
aws s3 cp s3://$S3_BUCKET_NAME/$S3_KEY_PREFIX'scripts'/gen_tbdsn.sh $TB_HOME/config/gen_tbdsn.sh
#aws s3 cp s3://$S3_BUCKET_NAME/scripts/gen_tbdsn.sh $TB_HOME/config/gen_tbdsn.sh
...
#aws s3 cp s3://$S3_BUCKET_NAME/scripts/tibero.template $TB_HOME/config/tibero.template
aws s3 cp s3://$S3_BUCKET_NAME/$S3_KEY_PREFIX'scripts'/gen_tibero_tip.sh $TB_HOME/config/gen_tibero_tip.sh
#aws s3 cp s3://$S3_BUCKET_NAME/scripts/gen_tibero_tip.sh $TB_HOME/config/gen_tibero_tip.sh
...
#aws s3 cp s3://$S3_BUCKET_NAME/scripts/set_kernel_env.sh $TB_HOME/config/set_kernel_env.sh
...
#aws s3 cp s3://$S3_BUCKET_NAME/lambda/lambda_failover.sh $TB_HOME/scripts/lambda_failover.sh
...
#aws s3 cp s3://$S3_BUCKET_NAME/tibero_install/jdk-7u80-linux-x64.tar.gz $USER_HOME/jdk-7u80-linux-x64.tar.gz
...
#aws s3 cp s3://$S3_BUCKET_NAME/tibero_config/gen_autodown_rhel.sh $USER_HOME/gen_autodown_rhel.sh
#aws s3 cp s3://$S3_BUCKET_NAME/tibero_config/gen_autodown_svc_rhel.sh $USER_HOME/gen_autodown_svc_rhel.sh
#aws s3 cp s3://$S3_BUCKET_NAME/tibero_config/set_autodown_rhel.sh $USER_HOME/set_autodown_rhel.sh
#chmod 755 $USER_HOME/set_autodown_rhel.sh
#sudo $USER_HOME/set_autodown_rhel.sh $USER_PARAM
#rm -rf $USER_HOME/set_autodown_rhel.sh

if [ "$1" == 'primary' ];
then
    aws s3 cp s3://$S3_BUCKET_NAME/$S3_KEY_PREFIX'scripts'/cm.template $TB_HOME/config/cm.template
#    aws s3 cp s3://$S3_BUCKET_NAME/scripts/cm.template $TB_HOME/config/cm.template
    aws s3 cp s3://$S3_BUCKET_NAME/$S3_KEY_PREFIX'scripts'/gen_cm_tip.sh $TB_HOME/config/gen_cm_tip.sh
#    aws s3 cp s3://$S3_BUCKET_NAME/scripts/gen_cm_tip.sh $TB_HOME/config/gen_cm_tip.sh
...
#    aws s3 cp s3://$S3_BUCKET_NAME/scripts/mount_volume_p.sh $TB_HOME/config/mount_volume_p.sh
...
#    aws s3 cp s3://$S3_BUCKET_NAME/scripts/make_snap_p.sh $TB_HOME/config/make_snap_p.sh
...
#    aws s3 cp s3://$S3_BUCKET_NAME/scripts/gen_db_p.sh $TB_HOME/config/gen_db_p.sh
...
#    aws s3 cp s3://$S3_BUCKET_NAME/scripts/make_volume_s.sh $TB_HOME/config/make_volume_s.sh
...
#    aws s3 cp s3://$S3_BUCKET_NAME/scripts/gen_db_s.sh $TB_HOME/config/gen_db_s.sh
...
#    aws s3 cp s3://$S3_BUCKET_NAME/scripts/observer.template $TB_HOME/config/observer.template
    aws s3 cp s3://$S3_BUCKET_NAME/$S3_KEY_PREFIX'scripts'/gen_observer_tip.sh $TB_HOME/config/gen_observer_tip.sh
#    aws s3 cp s3://$S3_BUCKET_NAME/scripts/gen_observer_tip.sh $TB_HOME/config/gen_observer_tip.sh
...
#    aws s3 cp s3://$S3_BUCKET_NAME/scripts/wait_tsc_o.sh $TB_HOME/config/wait_tsc_o.sh
...
#    aws s3 cp s3://$S3_BUCKET_NAME/lambda/lambda_event.sh $TB_HOME/scripts/lambda_event.sh
