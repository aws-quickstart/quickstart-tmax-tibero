...
image::../images/Tibero-DB-resource-CM.png[Architecture]
...
image::../images/Tibero-Various-function-command-CM.png[Architecture]
...
image::../images/Tibero-Clusters-Observermanager.png[Architecture]
...
image::../images/Tibero-Various-function-command-Observer.png[Architecture]
...
image::../images/Tibero-TSC-Information.png[Architecture]
...
image::../images/Tibero-TSC--Failover-mode.png[Architecture]
...
image::../images/Tibero-SwitchingDB(P,S).png[Architecture]
...
image::../images/Tibero-AWS-EventBridge.png[Architecture]

[#architecture11]
.Viewing Function of AWS Lambda
image::../images/Tibero-AWS-Lambda.png[Architecture]
...
[#architecture4]
.Viewing Various Function Commands of CM
image::../images/Tibero-Lambda-operating.png[Architecture]
